  ...
  <div id="wrap">
    ...
    <main>
      <section class="inputWrap">
        ...
        <div class="inputFile">
          <label class="image_zone_label">
            <input type="file" id="image_zone" accept="image/*" /><i
              class="fas fa-image"
            ></i
            >画像を選択する
          </label>
      ...
      <section class="outputWrap">
        <!-- コピー対象要素とコピーボタン -->
        <button id="copyText" onclick="copyToClipboard()">
...
export default {
  mounted() {
    ...
    tesseractScript.src = 'https://unpkg.com/tesseract.js@v2.0.2/dist/tesseract.min.js';
...
main {
  ...
  flex-wrap: wrap;
	...
	.inputWrap .image_zone_label, .outputWrap #copyText {
    width: 400px;
    height: auto;
    padding: 1em 0;
    position: relative;
	...
	.inputWrap .image_zone_label:hover,	.outputWrap #copyText:hover {
			transform: translateY(0.1em);
			transition: 0.2s;
			opacity: 0.7;
	}

	.inputWrap .image_zone_label i, .outputWrap #copyText i{
			position: absolute;
